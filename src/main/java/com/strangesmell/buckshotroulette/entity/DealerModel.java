...
@OnlyIn(Dist.CLIENT)
public class DealerModel extends HierarchicalModel<Dealer> implements ArmedModel {
    ...
    public DealerModel(ModelPart p_171045_) {
    ...
    public void setupAnim(Dealer p_104028_, float p_104029_, float p_104030_, float p_104031_, float p_104032_, float p_104033_) {
